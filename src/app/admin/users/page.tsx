  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="text-gray-500 text-sm">{loading ? '…' : `${users.length} registered accounts`}</p>
      </div>
                ...
                users.map((user) => {
                  ...
                  return (
                    <tr key={user.id} className="hover:bg-gray-800/40 transition-colors">
                      ...
                      <td className="px-5 py-4">
                        {user.isBanned ? (
                          <span className="px-2 py-0.5 rounded-md text-xs font-semibold border bg-red-900/60 text-red-300 border-red-700">Banned</span>
                        ) : (
                          <span className="px-2 py-0.5 rounded-md text-xs font-semibold border bg-emerald-900/60 text-emerald-300 border-emerald-700">Active</span>
                        )}
                      </td>
